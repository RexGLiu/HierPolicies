...
def plot_one_result(savefig):
    ...
    with sns.axes_style('ticks'):
        ...
        if savefig:
            plt.savefig('figs/HierRooms_indep_no_struct_prop_successful_first_visits_doors.png', dpi=300, bbox_inches='tight')
    ...
    with sns.axes_style('ticks'):
        ...
        if savefig:
            plt.savefig('figs/HierRooms_indep_no_struct_prop_successful_first_visits_sublvls.png', dpi=300, bbox_inches='tight')
    ...
    with sns.axes_style('ticks'):
        ...
        if savefig:
            plt.savefig('figs/HierRooms_indep_no_struct_prop_successful_first_visits_door0.png', dpi=300, bbox_inches='tight')
    ...
    with sns.axes_style('ticks'):
        ...
        if savefig:
            plt.savefig('figs/HierRooms_indep_no_struct_prop_successful_first_visits_door1.png', dpi=300, bbox_inches='tight')
    ...
    with sns.axes_style('ticks'):
        ...
        if savefig:
            plt.savefig('figs/HierRooms_indep_no_struct_prop_successful_first_visits_door2.png', dpi=300, bbox_inches='tight')
    ...
    with sns.axes_style('ticks'):
        ...
        if savefig:
            plt.savefig('figs/HierRooms_indep_no_struct_prop_successful_first_visits_door3.png', dpi=300, bbox_inches='tight')
