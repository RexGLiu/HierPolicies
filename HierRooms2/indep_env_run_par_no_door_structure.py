...
from model.generate_env import generate_room_args_indep3 as generate_room_args
...
if rank == 0:
    ...
    task_mutual_info = [ compute_task_mutual_info(*room_args[1]) for room_args in room_args_list]
...
if rank == 0:
    ...
    results.to_pickle("./HierarchicalRooms_indep_no_door_structure.pkl")
    pickle.dump( clusterings_hc, open( "HierarchicalRoomsClusterings_indep_no_door_structure.pkl", "wb" ) )
    pickle.dump( task_mutual_info, open ("TaskMutualInfo_indep_no_door_structure.pkl", "wb"))
