...
if rank == 0:
    ...
    for kk in range(n_sims):
        ...
        room_args = generate_room_args(*task_args, replacement=True)
...
if rank == 0:
    ...
    results.to_pickle("./HierarchicalRooms_indep_no_sublvl_structure.pkl")
    pickle.dump( clusterings_hc, open( "HierarchicalRoomsClusterings_indep_no_sublvl_structure.pkl", "wb" ) )
    pickle.dump( task_mutual_info, open ("TaskMutualInfo_indep_no_sublvl_structure.pkl", "wb"))
