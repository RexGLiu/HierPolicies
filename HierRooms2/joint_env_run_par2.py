...
if rank == 0:
    ...
    results.to_pickle("./HierarchicalRooms_joint2.pkl")
    pickle.dump( clusterings_hc, open( "HierarchicalRoomsClusterings_joint2_hc.pkl", "wb" ) )
    pickle.dump( task_mutual_info, open ("TaskMutualInfo_joint2_hc.pkl", "wb"))
