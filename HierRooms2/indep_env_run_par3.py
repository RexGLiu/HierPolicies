...
if rank == 0:
    ...
    results.to_pickle("./HierarchicalRooms_indep2.pkl")
    pickle.dump( clusterings_hc, open( "HierarchicalRoomsClusterings_indep2_hc.pkl", "wb" ) )
    pickle.dump( task_mutual_info, open ("TaskMutualInfo_indep2_hc.pkl", "wb"))
