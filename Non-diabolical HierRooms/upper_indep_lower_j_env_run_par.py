...
if rank == 0:
    ...
    context_balance = [4] * (len(mappings_idx))
...
if rank == 0:
    ...
    results.to_pickle("./HierarchicalRooms_upper_indep_lower_j.pkl")
    pickle.dump( clusterings_hc, open( "HierarchicalRoomsClusterings_upper_indep_lower_j_hc.pkl", "wb" ) )
    pickle.dump( task_mutual_info, open ("TaskMutualInfo_upper_indep_lower_j_hc.pkl", "wb"))
