...
class MultiStepAgent(object):
    ...
    def __init__(self, task, n_particles=300, p_max = 0.1, sample_tau = 1):
        self.task = task
...
class HierarchicalAgent(MultiStepAgent):
    def __init__(self, task, inv_temp=10.0, alpha0=1.0, alpha1=0.5, gamma=0.8,
                 stop_criterion=0.001,
                 mapping_prior=0.001, goal_prior=0.001,
                 n_particles=300, p_max = 0.1, sample_tau = 1):
        ...
        self.n_subtask_goals = self.task.n_subtask_goals
        ...
        self.rooms_hypotheses = [HierarchicalHypothesis(self.n_subtask_goals, 
                    self.n_primitive_actions, self.n_abstract_actions, self.inverse_temperature, 
                    self.gamma, self.stop_criterion, alpha0, alpha1, goal_prior, mapping_prior)]
